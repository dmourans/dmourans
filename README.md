...
#### 🚀 Meu momento atual
- 🔭 Trabalhando na criação de **plataformas web, automações e integração de dados**.
- 🌱 Focando em aprofundar meus conhecimentos práticos em **Pipelines, arquitetura Serverless e ecossistema Azure** (Functions, Key Vault).
- ⚙️ **Ferramentas diárias:** VS Code + GitHub Copilot.
...
#### 📚 Na minha cabeceira (e nos fones de ouvido)
Ultimamente tenho dedicado meu tempo às mais diversas leituras e sons:
